...
public class RareAnalyzer {
	...
	public RareAnalyzer(String synthetic_results_file, double gwas_pvalue_threshold, String genotype_file,
		...
		this.kinship=this.variants.read_in_kinship(kinship_file);
	 ...
	 */
	public RareAnalyzer(String synthetic_results_file, double synthetic_pvalue_threshold, double synthetic_maf_threhold, 
		...
		try{
			...
			for(int chr=0;chr<variants.num_chrs;chr++){
				for(int region_index=0;region_index<this.region_coordinates[chr].length;region_index++){
					...
					double[][] result_lm=EMMAX.reg2results_lm(reg1, emma.sample_size);
					if(result_lm!=null){
...
//					}					
	...
	public static void main(String[] args){
		...
		RareAnalyzer analyzer = new RareAnalyzer(synthetic_results_file_30, synthetic_pvalue_threshold, synthetic_maf_threhold, genotype_file, 
